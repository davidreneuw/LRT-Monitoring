...
cat /home/akovachi/lrt_data/log/filetransfer.log | mail -s "Transfer Log" andrew.kovachik@canada.ca, kovachik.andrew@gmail.com

test -s /home/akovachi/lrt_data/log/record/recordlrt`date +\%m\%d`.log && cat
/home/akovachi/lrt_data/log/recordlrt/recordlrt`date +\%m\%d`.log | mail -s "Interference Log" andrew.kovachik@canada.ca, kovachik.andrew@gmail.com
